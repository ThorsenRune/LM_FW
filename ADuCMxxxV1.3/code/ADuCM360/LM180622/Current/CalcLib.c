...
#include "CalcLib.h"				//	Mathematical functions
...
/*		the q31 dot product of two vectors with a q62 result. If intermediate result has more than
		SAFEBITRANGE+32 bits the overflow flag is set and the WINT_MIN is returned
	*/	
...
if ((tmp<SUM_MIN)||(tmp>SUM_MAX)){
		bErrFlags.errbits.Overflow_mVectorDotProduct=1;
																	//Overflow - fatal
